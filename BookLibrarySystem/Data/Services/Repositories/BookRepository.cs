...
namespace BookLibrarySystem.Data.Services.Repositories
{
    ...
    {
         IEnumerable<Books> GetListConstraint(string entityName, int index, int size, string cate);
         int GetCountConstraint(string entityName, string cate);
         IEnumerable<GroupCount> GetListCountByCategory();
